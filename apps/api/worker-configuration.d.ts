/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.\apps\api\wrangler.worker.jsonc .\apps\api\worker-configuration.d.ts` (hash: d5d0f680800556f8e11c17fc6a89e29b)
// Runtime types generated with workerd@1.20260811.1 2026-08-09 nodejs_compat
interface __BaseEnv_Env {
	R2_STORAGE: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	NODE_ENV: "production";
	DATABASE_MODE: "hyperdrive";
	TURNSTILE_ALLOWED_HOSTNAMES: "app.leurettech.com,admin.leurettech.com";
	JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_MODE" | "TURNSTILE_ALLOWED_HOSTNAMES" | "JWT_SECRET" | "TURNSTILE_SECRET_KEY" | "RESEND_API_KEY" | "EMAIL_FROM">> {}
}
