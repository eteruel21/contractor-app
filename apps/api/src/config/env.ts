...
const environmentSchema = z.object({
  ...
  CORS_ORIGINS: z
    .string()
    .default(
      "https://contractor-admin-web.pages.dev,https://contractor-pro-web.pages.dev,https://admin.contractor.com.pa,https://app.contractor.com.pa,https://staging-admin.contractor.app,https://staging-app.contractor.app,http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:8081,http://127.0.0.1:8081"
    ),
